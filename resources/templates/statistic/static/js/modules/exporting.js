...
'use strict';
(function (c) {
    "object" === typeof module && module.exports ? (c["default"] = c, module.exports = c) : "function" === typeof define &&
        define.amd ? define("highcharts/modules/exporting", ["highcharts"], function (q) {
            c(q);
            c.Highcharts = q;
            return c
    ...
    c = c ? c._modules : {};
    q(c, "Extensions/FullScreen.js", [c["Core/Chart/Chart.js"], c["Core/Globals.js"], c["Core/Renderer/HTML/AST.js"],
    c["Core/Utilities.js"]],
        function (c, m, h, k) {
            var n = k.addEvent;
            k = function () {
                ...
                c.prototype.open = function () {
                    ...
                    if (e.browserProps) {
                        var k = n(c.container.ownerDocument, e.browserProps.fullscreenChange,
                            function () {
                                e.isOpen ? (e.isOpen = !1, e.close()) : (c.setSize(null, null, !1),
                ...
                c.prototype.setButtonText = function () {
                    ...
                    k && k.menuItemDefinitions && e && e.exitFullscreen &&
                        e.viewFullscreen && m && c && c.length && h.setElementHTML(c[m.indexOf(
                            "viewFullscreen")], this.isOpen ? e.exitFullscreen : k.menuItemDefinitions
                                .viewFullscreen.text || e.viewFullscreen)
                };
    ...
    q(c, "Extensions/Exporting.js", [c["Core/Chart/Chart.js"], c["Mixins/Navigation.js"], c["Core/Globals.js"], c[
        "Core/DefaultOptions.js"], c["Core/Color/Palette.js"], c["Core/Renderer/SVG/SVGRenderer.js"], c[
    "Core/Utilities.js"]], function (c, m, h, k, n, q, e) {
        var z = h.doc,
            H = h.isTouchDevice,
            B = h.win;
        k = k.defaultOptions;
        ...
        A(c.prototype, {
            sanitizeSVG: function (a, b) {
                var f = a.indexOf("</svg>") + 6,
                    d = a.substr(f);
                a = a.substr(0, f);
                b && b.exporting && b.exporting.allowHTML && d && (d =
                    '<foreignObject x="0" y="0" width="' + b.chart.width + '" height="' + b
                        .chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' +
                    d.replace(/(<(?:img|br).*?(?=>))>/g, "$1 />") +
                    "</body></foreignObject>", a = a.replace("</svg>", d + "</svg>"));
                a = a.replace(/zIndex="[^"]+"/g, "").replace(/symbolName="[^"]+"/g, "").replace(
            ...
            getSVG: function (a) {
                ...
                e = f.exporting.sourceWidth || f.chart.width || /px$/.test(e) && parseInt(e, 10) ||
                    (f.isGantt ? 800 : 600);
                u = f.exporting.sourceHeight || f.chart.height || /px$/.test(u) && parseInt(u,
                    10) || 400;
                A(f.chart, {
                    animation: !1,
                    renderTo: d,
                ...
                this.axes.forEach(function (a) {
                    ...
                    a.options.isInternal || (h[a.coll] || (h[a.coll] = !0, f[a.coll] = []),
                        f[a.coll].push(p(a.userOptions, {
                            visible: a.visible
                        })))
                });
                ...
                this.axes.forEach(function (a) {
                    var b = I(g.axes, function (b) {
                        ...
                        f = d.userMin;
                    d = d.userMax;
                    b && ("undefined" !== typeof f && f !== b.min || "undefined" !==
                        typeof d && d !== b.max) && b.setExtremes(f, d, !0, !1)
                });
                e = g.getChartHTML();
                E(this, "getSVG", {
                    chartCopy: g
            ...
            getFilename: function () {
                ...
                "string" === typeof a && (b = a.toLowerCase().replace(/<\/?[^>]+(>|$)/g, "").replace(
                    /[\s_]+/g, "-").replace(/[^a-z0-9\-]/g, "").replace(/^[\-]+/g, "").replace(
                        /[\-]+/g, "-").substr(0, 24).replace(/[\-]+$/g, ""));
            ...
            beforePrint: function () {
                ...
                E(this, "beforePrint");
                b && this.chartWidth > b && (f.resetParams = [this.options.chart.width, void 0,
                !1], this.setSize(b, void 0, !1));
                [].forEach.call(f.childNodes, function (a, b) {
                    1 === a.nodeType && (f.origDisplay[b] = a.style.display, a.style.display =
                        "none")
                });
            ...
            print: function () {
                var a = this;
                a.isPrinting || (h.printingChart = a, h.isSafari || a.beforePrint(), setTimeout(
                    function () {
                        B.focus();
                        B.print();
            ...
            contextMenu: function (a, b, f, d, c, h, k) {
                ...
                if (!l) {
                    ...
                    b.forEach(function (a) {
                        "string" === typeof a && (a = g.options.exporting.menuItemDefinitions[
                            a]);
                        if (J(a, !0)) {
                            var b = void 0;
                            a.separator ? b = y("hr", null, null, p) : ("viewData" ===
                                a.textKey && g.isDataTableVisible && (a.textKey =
                                    "hideData"), b = y("li", {
                                        className: "highcharts-menu-item",
                                        onclick: function (b) {
                                            b && b.stopPropagation();
                                            l.hideMenu();
                                            a.onclick && a.onclick.apply(g,
                                                arguments)
                                        }
                                    }, null, p), b.appendChild(z.createTextNode(a.text ||
                                        g.options.lang[a.textKey])), g.styledMode || (b
                ...
                f + g.exportMenuWidth > m ? b.right = m - f - c - w + "px" : b.left = f - w +
                    "px";
                d + h + g.exportMenuHeight >
                    C && "top" !== k.alignOptions.verticalAlign ? b.bottom = C - d - w + "px" :
                    b.top = d + h - w + "px";
                r(l, b);
                r(g.renderTo, {
                    overflow: ""
            ...
            addButton: function (a) {
                ...
                if (!1 !== d.enabled && d.theme) {
                    ...
                    c ? C = function (a) {
                        ...
                        a && a.stopPropagation();
                        b.contextMenu(v.menuClassName, e, v.translateX, v.translateY, v
                            .width, v.height, v);
                        v.setState(2)
                    });
                    ...
                    b.styledMode || (g["stroke-linecap"] = "round", g.fill = t(g.fill, n.backgroundColor),
            ...
            destroyExport: function (a) {
                ...
                a && (a.forEach(function (a, d) {
                    a && (a.onclick = a.ontouchstart = null, c = "cache-" + a.menuClassName,
                        b[c] && delete b[c], b.exportSVGElements[d] = a.destroy()
                    )
                }), a.length = 0);
                ...
                f && (f.forEach(function (a, d) {
                    ...
                    K(a,
                        "mouseleave");
                    b.exportDivElements[d] = a.onmouseout = a.onmouseover = a.ontouchstart =
                        a.onclick = null;
                    F(a)
                }), f.length = 0);
        ...
        q.prototype.inlineBlacklist = [/-/, /^(clipPath|cssText|d|height|width)$/, /^font$/,
            ...
            function () {
                ...
                function b(c) {
                    function f(b, f) {
                        ...
                        w || z[f] === b && "svg" !== c.nodeName || g[c.nodeName][f] === b || (d && -1 ===
                            d.indexOf(f) ? l += a(f) + ":" + b + ";" : b && c.setAttribute(a(f), b))
                    }
                    var l = "",
                        w, r, t;
        ...
        D.menuball = function (a, b, c, d) {
            a = [];
            d = d / 3 - 2;
            return a = a.concat(D.circle(c - d, b, d, d), D.circle(c - d, b + d + 4, d, d), D.circle(c -
                d, b + 2 * (d + 4), d, d))
        };
        c.prototype.renderExporting = function () {
            ...
            d && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer
                .g("exporting-group").attr({
                    zIndex: 3
                }).add(),
                G(c, function (b) {
                    a.addButton(b)
