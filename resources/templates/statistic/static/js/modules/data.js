...
'use strict';
(function (b) {
    "object" === typeof module && module.exports ? (b["default"] = b, module.exports = b) : "function" === typeof define &&
        define.amd ? define("highcharts/modules/data", ["highcharts"], function (p) {
            b(p);
            b.Highcharts = p;
            return b
    ...
    p(b, "Extensions/Data.js", [b["Extensions/Ajax.js"], b["Core/Chart/Chart.js"], b["Core/Globals.js"], b[
        "Core/Series/Point.js"], b["Core/Series/SeriesRegistry.js"],
    b["Core/Utilities.js"]], function (b, p, u, G, H, c) {
        ...
        c = function () {
            function b(a, d, g) {
                this.options = this.rawColumns = this.firstRowAsNames = this.chartOptions = this.chart =
                    void 0;
                this.dateFormats = {
                    "YYYY/mm/dd": {
            ...
            b.prototype.getColumnDistribution = function () {
                ...
                d.forEach(function (d) {
                    ...
                    for (f = 0; f < l; f++) g.hasReader(z[f]) || g.addColumnReader(void 0,
                        z[f]);
                    b.push(g);
                    n++
                });
            ...
            b.prototype.parseCSV = function (a) {
                function d(a, d, g, e) {
                    ...
                    function h() {
                        f > n || n > O ? (++n, m = "") : (!isNaN(parseFloat(m)) && isFinite(m) ? (m =
                            parseFloat(m), k("number")) : isNaN(Date.parse(m)) ? k("string") :
                            (m = m.replace(/\//g, "-"), k("date")), C.length < t + 1 && C.push(
                                []), g || (C[t][d] = m), m = "", ++t, ++n)
                    }
                    var A = 0,
                        c = "",
                ...
                function g(a) {
                    ...
                    a.some(function (a, e) {
                        ...
                        for (var c = 0; c < a.length; c++) {
                            ...
                            else "undefined" !== typeof m[e] ? (k = k.trim(), isNaN(Date.parse(
                                k)) ? !isNaN(k) && isFinite(k) || m[e]++ : m[e]++,
                                k = "") : k += e;
                            "," === e && g++;
                            "." === e && d++
                        }
                    ...
                    e = m[";"] > m[","] ? ";" : ",";
                    b.decimalPoint || (b.decimalPoint = d > g ? "." : ",", k.decimalRegex = new RegExp(
                        "^(-?[0-9]+)" +
                        b.decimalPoint + "([0-9]+)$"));
                    return e
                }
                ...
                function e(a, d) {
                    ...
                    for (; g < d; g++)
                        if ("undefined" !== typeof a[g] && a[g] && a[g].length) {
                            var l = a[g].trim().replace(/\//g, " ").replace(/\-/g, " ").replace(
                                /\./g, " ").split(" ");
                            e = ["", "", ""];
                            for (f = 0; f < l.length; f++) f < e.length && (l[f] = parseInt(l[f],
                                10), l[f] && (m[f] = !m[f] || m[f] < l[f] ? l[f] : m[f],
                                    "undefined" !== typeof h[f] ? h[f] !== l[f] && (h[f] = !1) :
                                        h[f] = l[f], 31 < l[f] ? e[f] = 100 > l[f] ? "YY" : "YYYY" :
                                        12 < l[f] && 31 >= l[f] ? (e[f] = "dd", c = !0) : e[f].length ||
                                            (e[f] = "mm")))
                        } if (c) {
                            for (f = 0; f < h.length; f++) !1 !== h[f] ? 12 < m[f] && "YY" !== e[f] &&
                                "YYYY" !== e[f] && (e[f] = "YY") : 12 < m[f] && "mm" === e[f] && (e[f] =
                                    "dd");
                ...
                if (l) {
                    ...
                    b.columnTypes && 0 !== b.columnTypes.length || !v.length || !v[0].length ||
                        "date" !== v[0][1] || b.dateFormat || (b.dateFormat = e(C[0]));
                    this.dataFound()
                }
                return C
            };
            b.prototype.parseTable = function () {
                ...
                d && ("string" === typeof d && (d = x.getElementById(d)), [].forEach.call(d.getElementsByTagName(
                    "tr"), function (a, d) {
                        d >= e && d <= b && [].forEach.call(a.children, function (a, b) {
                            var k = g[b - c],
                                f = 1;
                            if (("TD" === a.tagName || "TH" === a.tagName) && b >=
                                c && b <= l)
                                for (g[b - c] || (g[b - c] = []), g[b - c][d - e] =
                                    a.innerHTML; d - e >= f && void 0 === k[d - e -
                                    f];) k[d - e - f] = null, f++
                        })
                    }),
                    this.dataFound());
            ...
            b.prototype.fetchLiveData = function () {
                function a(k) {
                    function f(f, h, m) {
                        ...
                        if (!f || !/^(http|\/|\.\/|\.\.\/)/.test(f)) return f && e.error && e.error(
                            "Invalid URL"), !1;
            ...
            b.prototype.parseGoogleSpreadsheet = function () {
                function a(d) {
                    var b = ["https://spreadsheets.google.com/feeds/cells", e, c,
                ...
                e && (delete g.googleSpreadsheetKey, a(function (a) {
                    ...
                    for (c = 0; c < g; c++) {
                        ...
                        if (q >= f && q <= p && k >= l && k <= n) {
                            ...
                            h = null;
                            t.numericValue ? h = 0 <= t.$t.indexOf("/") || 0 <= t.$t.indexOf(
                                "-") ? t.$t : 0 < t.$t.indexOf("%") ? 100 *
                                    parseFloat(t.numericValue) : parseFloat(t.numericValue) :
                                t.$t && t.$t.length && (h = t.$t);
                            e[q - f][k - l] = h
                        }
                    }
                    e.forEach(function (a) {
                        for (c = 0; c < a.length; c++) "undefined" === typeof a[
                            c] &&
                            (a[c] = null)
                    });
                    b && b.series ? b.update({
            ...
            b.prototype.trim = function (a, d) {
                "string" === typeof a && (a = a.replace(/^\s+|\s+$/g, ""), d && /^[0-9\s]+$/.test(a) &&
                    (a = a.replace(/\s/g, "")), this.decimalRegex && (a = a.replace(this.decimalRegex,
                        "$1.$2")));
                return a
            };
            ...
            b.prototype.parseColumn = function (a, d) {
                ...
                for (g[d] || (g[d] = []); b--;) {
                    ...
                    p || 0 === b && c ? a[b] = "" + y : +u === w ? (a[b] = w, 31536E6 < w &&
                        "float" !== r ? a.isDatetime = !0 : a.isNumeric = !0, "undefined" !==
                        typeof a[b + 1] && (q = w > a[b + 1])) : (y && y.length && (n = this.parseDate(
                            m)), l && E(n) && "float" !==
                                r ? (f[b] = m, a[b] = n, a.isDatetime = !0, "undefined" !== typeof a[b +
                                    1] && (m = n > a[b + 1], m !== q && "undefined" !== typeof q &&
                                        (this.alternativeFormat ? (this.dateFormat = this.alternativeFormat,
                                            b = a.length, this.alternativeFormat = this.dateFormats[
                                                this.dateFormat].alternative) : a.unsorted = !0), q = m
                                    )) : (a[b] = "" === y ? null : y, 0 !== b && (a.isDatetime || a.isNumeric) &&
                                        (a.mixed = !0)))
                }
                l && a.mixed && (e[d] = g[d]);
            ...
            b.prototype.parseDate = function (a) {
                ...
                if (d) var h = d(a);
                    ...
                    if (e) (d = this.dateFormats[e]) || (d = this.dateFormats["YYYY/mm/dd"]), (c = a
                        .match(d.regex)) && (h = d.parser(c));
                    else
                        for (b in this.dateFormats)
                            if (d = this.dateFormats[b], c = a.match(d.regex)) {
                                ...
                                h = d.parser(c);
                                break
                            } c || (a.match(/:.+(GMT|UTC|[Z+-])/) && (a = a.replace(
                                /\s*(?:GMT|UTC)?([+-])(\d\d)(\d\d)$/, "$1$2:$3").replace(
                                    /(?:\s+|GMT|UTC)([+-])/, "$1").replace(/(\d)\s*(?:GMT|UTC|Z)$/,
                                        "$1+00:00")), c = Date.parse(a), "object" === typeof c && null !==
                                            c && c.getTime ? h = c.getTime() - 6E4 * c.getTimezoneOffset() : E(c) &&
                                (h = c - 6E4 * (new Date(c)).getTimezoneOffset()))
                }
                return h
            };
            ...
            b.prototype.complete = function () {
                ...
                if (c.complete || c.afterComplete) {
                    ...
                    for (; 0 < n.length;) {
                        ...
                        for (e = 0; e < this.valueCount.global; e++) f.addColumnReader(void 0, this
                            .valueCount.globalPointArrayMap[e]);
                        f.populateColumns(n) && h.push(f)
                    }
                    0 < h.length && 0 < h[0].readers.length && (f = a[h[0].readers[0].columnIndex],
                        "undefined" !== typeof f && (f.isDatetime ? b = "datetime" : f.isNumeric ||
                            (b = "category")));
                    if ("category" ===
                        b)
                        for (e = 0; e < h.length; e++)
                            for (f = h[e], n = 0; n < f.readers.length; n++) "x" === f.readers[n].configName &&
            ...
            b.prototype.update = function (a, b) {
                ...
                a && (a.afterComplete = function (a) {
                    a &&
                        (a.xAxis && d.xAxis[0] && a.xAxis.type === d.xAxis[0].options.type &&
                ...
                afterComplete: function (b) {
                    ...
                    if (Object.hasOwnProperty.call(d, "series"))
                        if ("object" === typeof d.series)
                            for (e = Math.max(d.series.length, b && b.series ?
                                b.series.length :
                                0); e--;) {
                                var g = d.series[e] || {};
        ...
        var F = function () {
            ...
            b.prototype.read = function (a, b) {
                ...
                this.readers.forEach(function (c) {
                    ...
                    d ? e.push(g) : 0 < c.configName.indexOf(".") ? G.prototype.setNestedProperty(
                        e, g, c.configName) : e[c.configName] = g
                });
